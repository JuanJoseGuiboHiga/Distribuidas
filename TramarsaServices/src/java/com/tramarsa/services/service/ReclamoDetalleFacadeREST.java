...
import com.tramarsa.services.ReclamoDetalle;
...
public class ReclamoDetalleFacadeREST extends AbstractFacade<ReclamoDetalle> {
    ...
    @Path("{id}")
    @Consumes({"application/xml", "application/json"})
    public void edit(@PathParam("id") Integer id, ReclamoDetalle entity) {
        super.edit(entity);
    }
    ...
    public ReclamoDetalle find(@PathParam("id") Integer id) {
