...
import com.tramarsa.services.ReclamoDetalleFact;
...
public class ReclamoDetalleFactFacadeREST extends AbstractFacade<ReclamoDetalleFact> {
    ...
    @Path("{id}")
    @Consumes({"application/xml", "application/json"})
    public void edit(@PathParam("id") Integer id, ReclamoDetalleFact entity) {
        super.edit(entity);
    }
    ...
    public ReclamoDetalleFact find(@PathParam("id") Integer id) {
